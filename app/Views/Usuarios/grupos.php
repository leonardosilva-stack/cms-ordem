        ...
        <div class="user-block block">
            ...
            <?php if (empty($gruposDisponiveis)) : ?>
                ...
                <?php if ($usuario->full_control == false) : ?>
                    <p class="contributions mt-0">Esse usuário já faz parte de todos ao grupos disponíveis! </p>
                <?php else : ?>
                    <p class="contributions text-white mt-0">Esse usuário faz parte do grupo Administrador. Para associa-lo a outros grupos, primeiro remova-o do grupo Administrador!</p>
                <?php endif ?>

            <?php else : ?>
                <!-- Exibira os retorno do backend -->
                <div id="response">
                </div>
