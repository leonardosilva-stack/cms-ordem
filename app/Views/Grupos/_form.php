...
<div class="custom-control custom-checkbox">
    ...
    <a tabindex="0" style="text-decoration:none" role="button" data-toggle="popover" data-trigger="focus" title="Importante" data-content="Se esse grupo for definido como <b class='text-danger'>Exibir grupo de acesso</b> ele será mostrado como opção na hora de definir um <b>Responsável técnico</b> pela ordem de serviço.">&nbsp;&nbsp;<i class="fa fa-lg fa-question-circle text-danger"></i></a>
</div>