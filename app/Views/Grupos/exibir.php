    ...
    <?php if ($grupo->id < 3) : ?>
        <div class="col-md-12">
            <div class="alert alert-info" role="alert">
                ...
                <p>O grupo <b><?php echo esc($grupo->nome); ?></b> não pode ser editado ou excluído, pois os mesmos não podem ter suas permissões revogadas.</p>
                <hr>
                <p class="mb-0">Não se preocupe, pois os demais grupos pode ser editados ou removidos conforme se fizer necessário.</p>
            </div>
        </div>
    <?php endif ?>
